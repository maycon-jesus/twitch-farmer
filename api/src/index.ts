...
registerWebhookInCategory('notification-redemptions', process.env.DISCORD_REDEMPTIONS_WEBHOOK!)
...
function loadControllers() {
    ...
    const twitchUsers = new TwitchUsersController()
    setDependency('twitchUsers', twitchUsers)
